...
After watching https://www.youtube.com/watch?v=OtYKDzXwDEE[this Numberphile video] I got interested in
...
So after finding https://github.com/WestHealth/pyvis/issues/88[this issue], I decided to store the node positions after the physics were applied by doing the following:
...
The python code used to generate the graph can be found https://gist.github.com/WJehee/4d708b111190554fa88e55d517050b20[in this gist]
(you need to have https://networkx.org/[networkx] and https://pyvis.readthedocs.io/en/latest/index.html[pyvis] installed).
