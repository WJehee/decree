+++
title = 'Niks to Nix | Deployment'
date = 2025-12-07
description = 'Different deployment methods'
tags = ['self-hosting', 'nix']
+++

In a link:{{< ref "niks-to-nix" >}}[previous article] we set up NixOS on a VPS by manually booting from an ISO, partitioning the disk and running `nixos-install`.
