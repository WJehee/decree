...
Our main recommendations were to implement https://www.rfc-editor.org/rfc/rfc8482[RFC8482] to block ANY requests over UDP (reducing maximum amplification from ~70x to ~12x), clean up unnecessary TXT records, and introduce rate limiting on nameservers.
